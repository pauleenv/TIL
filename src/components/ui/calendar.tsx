    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 relative" // Added 'relative' here
        ),
        ...
        day_today: "bg-[#FFDD00] !text-black border-2 border-black shadow-custom-black",
        ...classNames,
      }}
      components={{
